...
ggplot(iris) +
  ...
  geom_point() +
  labs(x = "Add label to Sepal Length") +
  labs(y = "Add label to Sepal Width") +
...
Code comes from [https://emitanaka.rbind.io/post/knitr-knitr-code](https://emitanaka.rbind.io/post/knitr-knitr-code/)
